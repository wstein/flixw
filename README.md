...
```console
curl -fsSLO https://github.com/wstein/flixw/releases/download/v0.26.3/flixw-setup.java
...
```
0fb5a04f6d8953900254e9851dc783d98e6fdfff295c0eb22939c358685f4699  flixw-setup.java
```
...
```console
echo "0fb5a04f6d8953900254e9851dc783d98e6fdfff295c0eb22939c358685f4699  flixw-setup.java" \
...
```console
curl -fsSLO https://github.com/wstein/flixw/releases/download/v0.26.3/SHA256SUMS
...
Invoke-WebRequest -OutFile flixw-setup.java `
  https://github.com/wstein/flixw/releases/download/v0.26.3/flixw-setup.java
...
$ ./flixw validate
ok    ./flixw matches flixw 0.26.3
ok    ./flixw.cmd matches flixw 0.26.3
...
```console
base=https://github.com/wstein/flixw/releases/download/v0.26.3
curl -fsSLO $base/flixw-0.26.3.tar.gz
curl -fsSL  $base/SHA256SUMS | grep flixw-0.26.3.tar.gz | sha256sum -c -
tar -xzf flixw-0.26.3.tar.gz        # flixw, flixw.cmd, .flixw/flixw.java
rm flixw-0.26.3.tar.gz
...
On Windows the equivalents are `Get-FileHash flixw-0.26.3.tar.gz` and `Expand-Archive` in
PowerShell, or `certutil -hashfile flixw-0.26.3.tar.gz SHA256` and `tar -xf` in cmd.exe —
...
```console
$ ./flixw pin --refresh
flixw: rewrote .flixw/lock.toml in the shape flixw 0.26.3 writes; the pin is unchanged
```
