...
```console
curl -fsSLO https://github.com/wstein/flixw/releases/download/v0.34.1/flixw-setup.java
...
```
e492e263a72fa4d5edee751bf9e4894efee7aa2e20f3a1601b5fa22ece361352  flixw-setup.java
```
...
```console
echo "e492e263a72fa4d5edee751bf9e4894efee7aa2e20f3a1601b5fa22ece361352  flixw-setup.java" \
...
```console
curl -fsSLO https://github.com/wstein/flixw/releases/download/v0.34.1/SHA256SUMS
...
Invoke-WebRequest -OutFile flixw-setup.java `
  https://github.com/wstein/flixw/releases/download/v0.34.1/flixw-setup.java
...
$ ./flixw validate
ok    ./flixw matches flixw 0.34.1
ok    ./flixw.cmd matches flixw 0.34.1
...
```console
base=https://github.com/wstein/flixw/releases/download/v0.34.1
curl -fsSLO $base/flixw-0.34.1.tar.gz
curl -fsSL  $base/SHA256SUMS | grep flixw-0.34.1.tar.gz | sha256sum -c -
tar -xzf flixw-0.34.1.tar.gz        # flixw, flixw.cmd, .flixw/flixw.java
rm flixw-0.34.1.tar.gz
...
On Windows the equivalents are `Get-FileHash flixw-0.34.1.tar.gz` and `Expand-Archive` in
PowerShell, or `certutil -hashfile flixw-0.34.1.tar.gz SHA256` and `tar -xf` in cmd.exe —
...
```console
$ ./flixw pin --refresh
flixw: rewrote .flixw/lock.toml in the shape flixw 0.34.1 writes; the pin is unchanged
```
