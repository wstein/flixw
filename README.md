...
```console
curl -fsSLO https://github.com/wstein/flixw/releases/download/v0.34.2/flixw-setup.java
...
```
618d6f45f4e72c0171f4961f6df93562791c6be5cdbba6ebb82b28bdc613cd99  flixw-setup.java
```
...
```console
echo "618d6f45f4e72c0171f4961f6df93562791c6be5cdbba6ebb82b28bdc613cd99  flixw-setup.java" \
...
```console
curl -fsSLO https://github.com/wstein/flixw/releases/download/v0.34.2/SHA256SUMS
...
Invoke-WebRequest -OutFile flixw-setup.java `
  https://github.com/wstein/flixw/releases/download/v0.34.2/flixw-setup.java
...
$ ./flixw validate
ok    ./flixw matches flixw 0.34.2
ok    ./flixw.cmd matches flixw 0.34.2
...
```console
base=https://github.com/wstein/flixw/releases/download/v0.34.2
curl -fsSLO $base/flixw-0.34.2.tar.gz
curl -fsSL  $base/SHA256SUMS | grep flixw-0.34.2.tar.gz | sha256sum -c -
tar -xzf flixw-0.34.2.tar.gz        # flixw, flixw.cmd, .flixw/flixw.java
rm flixw-0.34.2.tar.gz
...
On Windows the equivalents are `Get-FileHash flixw-0.34.2.tar.gz` and `Expand-Archive` in
PowerShell, or `certutil -hashfile flixw-0.34.2.tar.gz SHA256` and `tar -xf` in cmd.exe —
...
```console
$ ./flixw pin --refresh
flixw: rewrote .flixw/lock.toml in the shape flixw 0.34.2 writes; the pin is unchanged
```
