...
curl -fsSLO https://github.com/wstein/flixw/releases/download/v0.21.0/flixw.java
...
Invoke-WebRequest -OutFile flixw.java `
  https://github.com/wstein/flixw/releases/download/v0.21.0/flixw.java
java flixw.java install .
...
$ ./flixw validate
ok    ./flixw matches flixw 0.21.0
ok    ./flixw.cmd matches flixw 0.21.0
ok    .flixw/flixw.java  sha256=3f304d41dd1ac34a...
...
```console
base=https://github.com/wstein/flixw/releases/download/v0.21.0
curl -fsSLO $base/flixw-0.21.0.tar.gz
curl -fsSL  $base/SHA256SUMS | grep flixw-0.21.0.tar.gz | shasum -a 256 -c -
...
On Windows, `Get-FileHash flixw-0.21.0.tar.gz` and `Expand-Archive` are the equivalents.
