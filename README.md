...
```console
curl -fsSLO https://github.com/wstein/flixw/releases/download/v0.31.2/flixw-setup.java
...
```
f696706d9db85a6125562ccf44f90b13cc9656d5c942d9191ab6dc618e9835d7  flixw-setup.java
```
...
```console
echo "f696706d9db85a6125562ccf44f90b13cc9656d5c942d9191ab6dc618e9835d7  flixw-setup.java" \
...
```console
curl -fsSLO https://github.com/wstein/flixw/releases/download/v0.31.2/SHA256SUMS
...
Invoke-WebRequest -OutFile flixw-setup.java `
  https://github.com/wstein/flixw/releases/download/v0.31.2/flixw-setup.java
...
$ ./flixw validate
ok    ./flixw matches flixw 0.31.2
ok    ./flixw.cmd matches flixw 0.31.2
...
```console
base=https://github.com/wstein/flixw/releases/download/v0.31.2
curl -fsSLO $base/flixw-0.31.2.tar.gz
curl -fsSL  $base/SHA256SUMS | grep flixw-0.31.2.tar.gz | sha256sum -c -
tar -xzf flixw-0.31.2.tar.gz        # flixw, flixw.cmd, .flixw/flixw.java
rm flixw-0.31.2.tar.gz
...
On Windows the equivalents are `Get-FileHash flixw-0.31.2.tar.gz` and `Expand-Archive` in
PowerShell, or `certutil -hashfile flixw-0.31.2.tar.gz SHA256` and `tar -xf` in cmd.exe —
...
```console
$ ./flixw pin --refresh
flixw: rewrote .flixw/lock.toml in the shape flixw 0.31.2 writes; the pin is unchanged
```
