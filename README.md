...
```console
curl -fsSLO https://github.com/wstein/flixw/releases/download/v0.34.6/flixw-setup.java
...
```
b5f7b140c96f186fdb9cb47fa344a36a02375ae2874f78b477830fa086b41c61  flixw-setup.java
```
...
```console
echo "b5f7b140c96f186fdb9cb47fa344a36a02375ae2874f78b477830fa086b41c61  flixw-setup.java" \
...
```console
curl -fsSLO https://github.com/wstein/flixw/releases/download/v0.34.6/SHA256SUMS
...
Invoke-WebRequest -OutFile flixw-setup.java `
  https://github.com/wstein/flixw/releases/download/v0.34.6/flixw-setup.java
...
$ ./flixw validate
ok    ./flixw matches flixw 0.34.6
ok    ./flixw.cmd matches flixw 0.34.6
...
```console
base=https://github.com/wstein/flixw/releases/download/v0.34.6
curl -fsSLO $base/flixw-0.34.6.tar.gz
curl -fsSL  $base/SHA256SUMS | grep flixw-0.34.6.tar.gz | sha256sum -c -
tar -xzf flixw-0.34.6.tar.gz        # flixw, flixw.cmd, .flixw/flixw.java
rm flixw-0.34.6.tar.gz
...
On Windows the equivalents are `Get-FileHash flixw-0.34.6.tar.gz` and `Expand-Archive` in
PowerShell, or `certutil -hashfile flixw-0.34.6.tar.gz SHA256` and `tar -xf` in cmd.exe —
...
```console
$ ./flixw pin --refresh
flixw: rewrote .flixw/lock.toml in the shape flixw 0.34.6 writes; the pin is unchanged
```
