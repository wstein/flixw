...
```console
curl -fsSLO https://github.com/wstein/flixw/releases/download/v0.34.5/flixw-setup.java
...
```
25eb3a6d88b5b7e928bf9cc26bd873775c32cc364b3f5b04634eb83cb91f2d50  flixw-setup.java
```
...
```console
echo "25eb3a6d88b5b7e928bf9cc26bd873775c32cc364b3f5b04634eb83cb91f2d50  flixw-setup.java" \
...
```console
curl -fsSLO https://github.com/wstein/flixw/releases/download/v0.34.5/SHA256SUMS
...
Invoke-WebRequest -OutFile flixw-setup.java `
  https://github.com/wstein/flixw/releases/download/v0.34.5/flixw-setup.java
...
$ ./flixw validate
ok    ./flixw matches flixw 0.34.5
ok    ./flixw.cmd matches flixw 0.34.5
...
```console
base=https://github.com/wstein/flixw/releases/download/v0.34.5
curl -fsSLO $base/flixw-0.34.5.tar.gz
curl -fsSL  $base/SHA256SUMS | grep flixw-0.34.5.tar.gz | sha256sum -c -
tar -xzf flixw-0.34.5.tar.gz        # flixw, flixw.cmd, .flixw/flixw.java
rm flixw-0.34.5.tar.gz
...
On Windows the equivalents are `Get-FileHash flixw-0.34.5.tar.gz` and `Expand-Archive` in
PowerShell, or `certutil -hashfile flixw-0.34.5.tar.gz SHA256` and `tar -xf` in cmd.exe —
...
```console
$ ./flixw pin --refresh
flixw: rewrote .flixw/lock.toml in the shape flixw 0.34.5 writes; the pin is unchanged
```
