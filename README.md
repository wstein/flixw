...
```console
curl -fsSLO https://github.com/wstein/flixw/releases/download/v0.34.3/flixw-setup.java
...
```
f265254d1441cbb23d2a58e5a33687499e2d20ba2dd8195a60bf37d6965611f5  flixw-setup.java
```
...
```console
echo "f265254d1441cbb23d2a58e5a33687499e2d20ba2dd8195a60bf37d6965611f5  flixw-setup.java" \
...
```console
curl -fsSLO https://github.com/wstein/flixw/releases/download/v0.34.3/SHA256SUMS
...
Invoke-WebRequest -OutFile flixw-setup.java `
  https://github.com/wstein/flixw/releases/download/v0.34.3/flixw-setup.java
...
$ ./flixw validate
ok    ./flixw matches flixw 0.34.3
ok    ./flixw.cmd matches flixw 0.34.3
...
```console
base=https://github.com/wstein/flixw/releases/download/v0.34.3
curl -fsSLO $base/flixw-0.34.3.tar.gz
curl -fsSL  $base/SHA256SUMS | grep flixw-0.34.3.tar.gz | sha256sum -c -
tar -xzf flixw-0.34.3.tar.gz        # flixw, flixw.cmd, .flixw/flixw.java
rm flixw-0.34.3.tar.gz
...
On Windows the equivalents are `Get-FileHash flixw-0.34.3.tar.gz` and `Expand-Archive` in
PowerShell, or `certutil -hashfile flixw-0.34.3.tar.gz SHA256` and `tar -xf` in cmd.exe —
...
```console
$ ./flixw pin --refresh
flixw: rewrote .flixw/lock.toml in the shape flixw 0.34.3 writes; the pin is unchanged
```
