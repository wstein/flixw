...
# it is asking for.
MAX_CODE_LINES=2951          # purge adds a new capability; target: 2900 -- see AGENTS.md
MIN_COMMENT_PCT=25           # floor, not a ceiling; today 27
MAX_BYTES=256877             # purge adds a new capability; target: 225000, derived from the two numbers above
