...
# it is asking for.
MAX_CODE_LINES=3881          # wrapper --upgrade --global refreshes the machine-wide
                             # launcher and stage 0 cache with no project at all, on top
                             # of the self-compile-on-upgrade capability just above it;
                             # target: 2900
MIN_COMMENT_PCT=25           # floor, not a ceiling; today 34
MAX_BYTES=354816             # same --global capability; target: 225000
