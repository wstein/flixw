...
# it is asking for.
MAX_CODE_LINES=3268          # --upgrade takes a version; target: 2900 -- see AGENTS.md
MIN_COMMENT_PCT=25           # floor, not a ceiling; today 33
MAX_BYTES=296552             # --upgrade takes a version; target: 225000, derived from the two above
